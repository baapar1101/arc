    ...
    return [
      ...
      SettingsCategory(
        ...
        items: [
          ...
          SettingsItem(
            id: 'fx_providers_admin',
            title: 'settingsFxProvidersAdmin',
            description: 'settingsFxProvidersAdminDescription',
            icon: Icons.cloud_sync_outlined,
            color: const Color(0xFF00897B),
            route: '/user/profile/system-settings/fx-providers',
            categoryId: 'financial_payment',
            order: 3,
          ),
          SettingsItem(
      ...
      SettingsCategory(
        ...
        items: [
          ...
          SettingsItem(
            id: 'support_plans',
            title: 'settingsSupportPlans',
            description: 'settingsSupportPlansDescription',
            icon: Icons.card_membership_outlined,
            color: const Color(0xFF00897B),
            route: '/user/profile/system-settings/support-plans',
            categoryId: 'users_businesses',
            order: 5,
          ),
          SettingsItem(
            id: 'support_billing_stats',
            title: 'settingsSupportBillingStats',
            description: 'settingsSupportBillingStatsDescription',
            icon: Icons.bar_chart_outlined,
            color: const Color(0xFF5C6BC0),
            route: '/user/profile/system-settings/support-billing-stats',
            categoryId: 'users_businesses',
            order: 6,
          ),
        ],
      ...
      SettingsCategory(
        ...
        items: [
          ...
          SettingsItem(
            id: 'notification_event_defaults',
            title: 'قالب‌های پیش‌فرض کسب‌وکار',
            description: 'متن پیش‌فرض SMS/Email برای رویدادها وقتی کسب‌وکار قالب ندارد',
            icon: Icons.article_outlined,
            color: const Color(0xFF5D4037),
            route: '/user/profile/system-settings/notification-event-defaults',
            categoryId: 'communications',
            order: 5,
          ),
          SettingsItem(
      ...
      SettingsCategory(
        ...
        items: [
          ...
          SettingsItem(
            ...
            title: 'settingsAIProviderCredentials',
            description: 'settingsAIProviderCredentialsDescription',
            icon: Icons.vpn_key_outlined,
            color: const Color(0xFF6A1B9A),
            route: '/user/profile/system-settings/ai-provider-credentials',
            categoryId: 'ai',
            order: 2,
          ),
          SettingsItem(
            id: 'ai_models',
            title: 'settingsAIModels',
            description: 'settingsAIModelsDescription',
            icon: Icons.hub_outlined,
            color: const Color(0xFF7B1FA2),
            route: '/user/profile/system-settings/ai-models',
            categoryId: 'ai',
            order: 3,
          ),
          SettingsItem(
          ...
          SettingsItem(
            id: 'ai_skills',
            title: 'settingsAISkills',
            description: 'settingsAISkillsDescription',
            icon: Icons.extension_outlined,
          ...
          SettingsItem(
            id: 'ai_marketplace',
            title: 'settingsAIMarketplace',
            description: 'settingsAIMarketplaceDescription',
      ...
      SettingsCategory(
        ...
        items: [
          ...
          SettingsItem(
            id: 'business_activity_logs',
            title: 'settingsBusinessActivityLogs',
            description: 'settingsBusinessActivityLogsDescription',
            icon: Icons.history_outlined,
            color: const Color(0xFF6A1B9A),
            route: '/user/profile/system-settings/business-activity-logs',
            categoryId: 'monitoring_logs',
            order: 3,
          ),
          SettingsItem(
