...
class _JournalLedgerReportPageState extends State<JournalLedgerReportPage> {
  ...
  Future<void> _exportElectronicBooks() async {
    ...
    try {
      ...
      String filename = 'electronic_journal_ledger_${DateTime.now().millisecondsSinceEpoch}.$extension';
  ...
  DataTableConfig<Map<String, dynamic>> _buildTableConfig(AppLocalizations t) {
    return DataTableConfig<Map<String, dynamic>>(
      ...
      persistTableFiltersPageId: ListFilterPageIds.journalLedgerReportTable,
      ...
      customHeaderActions: [
        Tooltip(
          message: 'خروجی مطابق قالب سامانه دفاتر الکترونیکی سازمان امور مالیاتی',
          child: FilledButton.tonalIcon(
            ...
            label: const Text('دفتر الکترونیکی'),
          ),
        ),
      ],
