...
class _PnlCumulativeReportPageState extends State<PnlCumulativeReportPage> {
  ...
  Future<void> _exportExcel() async {
    ...
    try {
      ...
      final bytes = await api.post<List<int>>(
        '/api/v1/businesses/${widget.businessId}/reports/pnl-cumulative/export/excel',
        data: requestData,
      ...
      if (kIsWeb) {
        await web_utils.saveBytesAsFileWeb(
          data,
          'pnl_cumulative_${widget.businessId}.xlsx',
  ...
  Future<void> _exportPdf() async {
    ...
    try {
      ...
      final bytes = await api.post<List<int>>(
        '/api/v1/businesses/${widget.businessId}/reports/pnl-cumulative/export/pdf',
        data: requestData,
        responseType: ResponseType.bytes,
        options: Options(
      ...
      if (kIsWeb) {
        await web_utils.saveBytesAsFileWeb(
          data,
          'pnl_cumulative_${widget.businessId}.pdf',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(t.reportsPnlCumulativeTitle),
        actions: [
            ...
            child: Padding(
              ...
              child: Wrap(
                ...
                children: [
                  ...
                  // Date To (شروع همیشه ابتدای سال مالی است)
                  SizedBox(
                    width: 180,
