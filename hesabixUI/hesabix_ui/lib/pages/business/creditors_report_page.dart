...
class _CreditorsReportPageState extends State<CreditorsReportPage> {
  ...
  DataTableConfig<Map<String, dynamic>> _buildTableConfig(AppLocalizations t) {
    return DataTableConfig<Map<String, dynamic>>(
      endpoint: '/api/v1/persons/businesses/${widget.businessId}/reports/creditors',
      businessId: widget.businessId,
      persistTableFiltersPageId: ListFilterPageIds.creditorsReportTable,
      reportModuleKey: 'creditors',
      reportSubtype: 'list',
      ...
      rowColorBuilder: (item, index) {
        try {
          ...
          if (b > 0) {
            return SemanticColorResolver.positive(context).withValues(alpha: 0.05);
          }
        } catch (_) {}
        return null;
      },
