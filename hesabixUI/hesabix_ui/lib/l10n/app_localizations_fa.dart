...
class AppLocalizationsFa extends AppLocalizations {
  ...
  String get loanFacilityFieldLenderBank =>
      'حساب بانکی دریافت / پرداخت تسهیلات';
  ...
  String get loanFacilityConfirmDeleteDraftBody =>
      'در صورت نبود مانع حسابداری، این تسهیلات، اقساط، پرداخت‌ها و اسناد مرتبط حذف می‌شوند.';
  ...
  String get loanFacilityRegenerateValidationDisburseBank =>
      'برای ثبت سند، حساب بانکی دریافت تسهیلات را انتخاب کنید';
  ...
  String get permissionsConfirmEnableAllBody =>
      'تمام دسترسی‌ها برای این کاربر روشن می‌شود، از جمله موارد حساس مانند برگردان سال مالی و مدیریت کاربران. ادامه می‌دهید؟';
  ...
  String get permissionsConfirmDisableAllBody =>
      'تمام دسترسی‌های این کاربر خاموش می‌شود و تا زمان تغییر مجدد، به بخش‌های اصلی دسترسی نخواهد داشت. ادامه می‌دهید؟';
  ...
  String get appLevelPermissionsConfirmEnableBody =>
      'همهٔ دسترسی‌های سطح اپلیکیشنِ فهرست‌شده برای این کاربر روشن می‌شود. ادامه می‌دهید؟';

  @override
  String get appLevelPermissionsConfirmDisableBody =>
      'همهٔ دسترسی‌های سطح اپلیکیشنِ فهرست‌شده برای این کاربر خاموش می‌شود. ادامه می‌دهید؟';
  ...
  String get workflowBasalamPluginInactiveHint =>
      'افزونهٔ باسلام غیرفعال است. برای اجرای این نود آن را از بازار افزونه‌ها فعال کنید.';

  @override
  String get workflowBasalamPluginInactivePalette =>
      'افزونهٔ باسلام غیرفعال است؛ از بازار افزونه‌ها فعال کنید.';
  ...
  String get workflowBasalamRefreshPluginStatus =>
      'به‌روزرسانی وضعیت افزونهٔ باسلام';

  @override
  String get workflowBasalamRefreshPluginFailed =>
      'به‌روزرسانی وضعیت افزونه ناموفق بود. دوباره تلاش کنید.';
  ...
  String get reportsBasalamOverviewSubtitle =>
      'وب‌هوک، صف خطا، تعارض محصول و تعداد فاکتور سینک‌شده';

  @override
  String get reportsBasalamSyncedInvoicesTitle =>
      'فاکتورهای سینک‌شده از باسلام';

  @override
  String get reportsBasalamSyncedInvoicesSubtitle =>
      'لیست فاکتور فروش با شناسه سفارش باسلام';
  ...
  String get reportsBasalamDeadLetterSubtitle =>
      'مواردی که نیاز به رسیدگی دستی دارند';
  ...
  String get reportsWooOverviewSubtitle =>
      'سفارش به تفکیک وضعیت، محصولات، مشتریان و روند هفت روز اخیر';
  ...
  String get reportsWooRecentOrdersSubtitle =>
      'جدول سفارشات خوانده‌شده از پل فروشگاه';
