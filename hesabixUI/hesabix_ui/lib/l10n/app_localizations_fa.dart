...
class AppLocalizationsFa extends AppLocalizations {
  ...
  @override
  String get notificationsWebhookRegisterOptionsTitle => 'گزینه‌های ثبت وب‌هوک';

  @override
  String get notificationsWebhookDropPendingLabel => 'هنگام ثبت، صف به‌روزرسانی‌های معلق پیام‌رسان پاک شود';

  @override
  String get notificationsWebhookDropPendingHelp => 'حالت پیش‌فرض (خاموش): با ثبت مجدد وب‌هوک، به‌روزرسانی‌هایی که سرور پیام‌رسان در صف نگه داشته حفظ می‌شوند و در سیکل تحویل بعدی به سرور شما ارسال می‌شوند.\n\nاگر این گزینه را روشن کنید، همان لحظه آن صف خالی می‌شود و آن پیام‌ها دیگر به وب‌هوک شما نمی‌رسند؛ معمولاً پس از تغییر آدرس یا برای رفع گیر موقت مفید است. پیام‌های خروجی ربات را حذف نمی‌کند.';
