...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get notificationsWebhookRegisterOptionsTitle => 'Webhook registration options';

  @override
  String get notificationsWebhookDropPendingLabel => 'Clear pending messenger updates when registering';

  @override
  String get notificationsWebhookDropPendingHelp => 'Default (off): when you re-register the webhook, updates the messenger has queued are kept and will be delivered in the next delivery cycle to your server.\n\nIf you turn this on, that queue is cleared at registration time and those updates will not be sent to your webhook; useful after URL changes or to recover from a stuck queue. Does not remove outgoing bot messages.';
