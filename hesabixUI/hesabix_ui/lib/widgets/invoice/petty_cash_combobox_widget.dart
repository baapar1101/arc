...
class _PettyCashComboboxWidgetState extends State<PettyCashComboboxWidget> {
  ...
  void didUpdateWidget(covariant PettyCashComboboxWidget oldWidget) {
    ...
    if (oldWidget.selectedPettyCashId != widget.selectedPettyCashId ||
  ...
  String _displayLineText() {
    ...
    if (widget.selectedPettyCashId != null && widget.selectedPettyCashId!.isNotEmpty) {
  ...
  Future<void> _performSearch(String query) async {
    ...
    try {
      ...
      context,
      message:
          'خطا در دریافت لیست تنخواه‌گردان‌ها: ${ErrorExtractor.forContext(e, context)}',
    );
    }
  }
    ...
    if (widget.dense) {
      return TextFormField(
        ...
        validator: widget.isRequired
            ? (_) {
                if (widget.selectedPettyCashId == null || widget.selectedPettyCashId!.isEmpty) {
        ...
        decoration: InputDecoration(
          ...
          prefixIcon: Icon(Icons.wallet, color: theme.colorScheme.primary, size: 20),
