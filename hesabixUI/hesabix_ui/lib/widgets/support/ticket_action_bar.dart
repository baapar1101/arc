        ...
        children: [
          ...
          _field(
            ...
            child: DropdownButton<int>(
              ...
              isDense: true,
              underline: const SizedBox.shrink(),
              items: priorities.map((p) => DropdownMenuItem(value: p.id, child: Text(p.name))).toList(),
          ...
          _field(
            ...
            child: DropdownButton<int?>(
              ...
              items: [
                ...
                ...operators.map((op) => DropdownMenuItem<int?>(value: op.id, child: Text(op.displayName))),
              ],
