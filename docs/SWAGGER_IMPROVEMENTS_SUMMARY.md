# 📋 خلاصه بهبودهای Swagger UI - پروژه مارک‌استریت
...
- رنگ‌بندی برند مارک‌استریت (آبی #366092)
- لوگو در Topbar
...
**ویژگی‌ها:**
- ✅ ظاهر حرفه‌ای با رنگ‌بندی مارک‌استریت
...
| **رنگ‌بندی** | سبز استاندارد | آبی مارک‌استریت (#366092) |
...
از شما که برای بهبود تجربه کاربری مارک‌استریت وقت گذاشتید، متشکریم! 💙
