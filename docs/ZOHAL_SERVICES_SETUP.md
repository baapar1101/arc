...
حساب هزینه سرویس‌های استعلامات (70509) باید ایجاد شود:
...
این اسکریپت حساب `70509` (هزینه سرویس‌های استعلامات) را در گروه هزینه‌های عمومی (705) ایجاد می‌کند.
...
**ردیف‌های حسابداری:**
- **بدهکار:** حساب `70509` (هزینه سرویس‌های استعلامات) - مبلغ: قیمت سرویس
