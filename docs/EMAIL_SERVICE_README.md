# سرویس ایمیل مارک‌استریت

## نمای کلی

سرویس ایمیل مارک‌استریت یک سیستم داخلی برای ارسال ایمیل است که توسعه‌دهندگان می‌توانند به راحتی از آن استفاده کنند. این سرویس از SMTP استفاده می‌کند و تنظیمات اتصال در دیتابیس ذخیره می‌شود.
