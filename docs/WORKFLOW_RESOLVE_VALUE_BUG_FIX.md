...
### خلاصه:
در دیزاینر ورک‌فلو، زمانی که کاربر با ایمیل `support@markstreet.co` در نود "ارسال پیام تلگرام" انتخاب می‌شود، در لاگ اجرا خطای **"user_id مشخص نشده است"** نمایش داده می‌شود.

### جزئیات:
- ✅ user_id در دیتابیس صحیح ذخیره شده: `"1"`
- ✅ کاربر وجود دارد: support@markstreet.co (ID: 1)
