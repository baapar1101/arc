# 📚 راهنمای سفارسی‌سازی Swagger UI مارک‌استریت

## 🎯 خلاصه تغییرات

این سند خلاصه‌ای از تغییرات انجام شده برای بهبود ظاهر و خوانایی Swagger UI در پروژه مارک‌استریت است.
...
### 3️⃣ **رنگ‌بندی برند مارک‌استریت**
- ✅ رنگ اصلی: `#366092` (آبی مارک‌استریت)
...
| **رنگ‌بندی** | سبز استاندارد Swagger | آبی مارک‌استریت (#366092) |
| **لوگو** | ❌ ندارد | ✅ لوگو مارک‌استریت در Topbar |
