...
def upgrade() -> None:
    ...
    op.alter_column('businesses', 'business_type',
               existing_type=sa.Enum('شرکت', 'مغازه', 'فروشگاه', 'اتحادیه', 'باشگاه', 'موسسه', 'شخصی', name='business_type_enum', create_type=False),
    ...
    op.alter_column('businesses', 'business_field',
               existing_type=sa.Enum('تولیدی', 'بازرگانی', 'خدماتی', 'سایر', name='business_field_enum', create_type=False),
...
def downgrade() -> None:
    ...
    op.alter_column('businesses', 'business_field',
               ...
               type_=sa.Enum('تولیدی', 'بازرگانی', 'خدماتی', 'سایر', name='business_field_enum', create_type=False),
               existing_nullable=False)
    op.alter_column('businesses', 'business_type',
               existing_type=sa.Enum('COMPANY', 'SHOP', 'STORE', 'UNION', 'CLUB', 'INSTITUTE', 'INDIVIDUAL', name='businesstype'),
               type_=sa.Enum('شرکت', 'مغازه', 'فروشگاه', 'اتحادیه', 'باشگاه', 'موسسه', 'شخصی', name='business_type_enum', create_type=False),
               existing_nullable=False)
