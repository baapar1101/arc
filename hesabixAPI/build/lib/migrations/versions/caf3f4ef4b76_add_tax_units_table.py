...
def upgrade() -> None:
    ...
    op.alter_column('persons', 'person_type',
               existing_type=sa.Enum('مشتری', 'بازاریاب', 'کارمند', 'تامین\u200cکننده', 'همکار', 'فروشنده', 'سهامدار', name='person_type_enum', create_type=False),
               comment='نوع شخص',
    ...
    op.alter_column('products', 'item_type',
               existing_type=sa.Enum('کالا', 'خدمت', name='product_item_type_enum', create_type=False),
