...
class User(Base):
	...
	mobile_verified: Mapped[bool] = mapped_column(Boolean, default=False, nullable=False, index=True)
	...
	# آخرین فعالیت اپ (ضربان از کلاینت؛ برای نمایش آنلاین/اخیر بدون Redis)
