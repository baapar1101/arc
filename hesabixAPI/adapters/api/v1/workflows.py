...
async def get_actions_metadata(
    ...
    for action in all_actions:
        ...
        elif action_key == "create_notification":
            translation_context = "create_notification"
...
async def get_workflow_translations(
    ...
    all_translations["create_notification"] = CREATE_NOTIFICATION_TRANSLATIONS.get(lang, {})
