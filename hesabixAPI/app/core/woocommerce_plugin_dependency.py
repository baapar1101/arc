"""بررسی فعال بودن افزونهٔ بازار «ووکامرس / ArcWOC» برای کسب‌وکار."""
...
PLUGIN_CODE = "woocommerce_hesabix"


def check_woocommerce_plugin_active(db: Session, business_id: int) -> bool:
	plugin = (
