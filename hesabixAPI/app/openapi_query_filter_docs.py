...
بسیاری از endpointهای **لیست** (اشخاص، فاکتور، کالا، چک، دریافت/پرداخت، …) بدنهٔ JSON با ساختار **`QueryInfo`** می‌پذیرند. این همان مدلی است که UI مارک‌استریت در جداول داده استفاده می‌کند.
