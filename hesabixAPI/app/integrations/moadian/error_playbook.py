...
_PLAYBOOK: Dict[str, Dict[str, str]] = {
    ...
    "PERSON_ECONOMIC_CODE_INVALID": {
        ...
        "explanation": (
            "کد اقتصادی باید ۱۱ یا ۱۴ رقم باشد. مقادیر نامعتبر در ارسال نوع ۲ نادیده گرفته می‌شوند."
        ),
        "action": "کد اقتصادی را اصلاح کنید، یا برای ارسال نوع ۲ آن را خالی بگذارید.",
        "action_route": "person",
        "action_label": "ویرایش طرف‌حساب",
        "severity": "warning",
    },
    "PERSON_TAX_ID_MISSING": {
        ...
        "explanation": (
            "بدون کد ملی/اقتصادی معتبر، فاکتور به‌صورت نوع ۲ (مصرف‌کننده نهایی، بدون اطلاعات خریدار) "
            "ارسال می‌شود. برای نوع ۱ هویت خریدار را تکمیل کنید."
        ),
        "action": "در صورت نیاز به نوع ۱، کد ملی یا کد اقتصادی طرف‌حساب را تکمیل کنید؛ در غیر این صورت ارسال نوع ۲ مجاز است.",
        "action_route": "person",
        "action_label": "ویرایش طرف‌حساب",
        "severity": "info",
    },
    "PERSON_NATIONAL_ID_INVALID": {
        ...
        "explanation": (
            "کد ملی باید ۱۰ رقم (حقیقی) یا شناسه ملی ۱۱ رقم (حقوقی) باشد. "
            "مقدار نامعتبر در ارسال نوع ۲ نادیده گرفته می‌شود."
        ),
        "action": "کد را اصلاح کنید، یا برای ارسال نوع ۲ آن را خالی بگذارید.",
        "action_route": "person",
        "action_label": "ویرایش طرف‌حساب",
        "severity": "warning",
    },
