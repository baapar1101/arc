    ...
    *,
    ...
    if pk and not cert:
        warnings.append({
            ...
            "level": "error",
            "message": (
                "گواهی امضای الکترونیک (PEM) در تنظیمات ذخیره نشده است. "
                "پس از تأیید CSR در کارپوشه مودیان، گواهی را از مرکز صدور (GICA / "
                "دفتر مالیاتی / سامانه CSR) دریافت و متن PEM آن را در فیلد گواهی "
                "قرار دهید. API v2 بدون گواهی معتبر کار نمی‌کند."
            ),
        })
