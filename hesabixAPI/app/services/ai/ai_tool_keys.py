...
TOOL_L10N_KEYS: Dict[str, str] = {
    ...
    "create_warehouse_document": "aiToolCreateWarehouseDocument",
    ...
    "list_price_list_items": "aiToolListPriceListItems",
    ...
    "update_expense_income": "aiToolUpdateExpenseIncome",
    "update_receipt_payment": "aiToolUpdateReceiptPayment",
    ...
    "list_workflow_trigger_catalog": "aiToolListWorkflowTriggerCatalog",
    "list_workflow_action_catalog": "aiToolListWorkflowActionCatalog",
    "list_workflow_builtin_nodes": "aiToolListWorkflowBuiltinNodes",
    "get_workflow_component_schema": "aiToolGetWorkflowComponentSchema",
    "get_workflow_design_rules": "aiToolGetWorkflowDesignRules",
    "validate_workflow_draft": "aiToolValidateWorkflowDraft",
    "get_workflow": "aiToolGetWorkflow",
    "create_workflow": "aiToolCreateWorkflow",
    "update_workflow": "aiToolUpdateWorkflow",
    "delete_workflow": "aiToolDeleteWorkflow",
    "test_workflow": "aiToolTestWorkflow",
    "get_workflow_execution_debug": "aiToolGetWorkflowExecutionDebug",
    ...
    "list_memory_items": "aiToolListMemoryItems",
    "upsert_memory_item": "aiToolUpsertMemoryItem",
    "delete_memory_item": "aiToolDeleteMemoryItem",
    "read_memory": "aiToolGetUserMemory",
    "upsert_memory_entry": "aiToolUpsertMemoryItem",
    "delete_memory_entry": "aiToolDeleteMemoryItem",
...
TOOL_LABELS_FA: Dict[str, str] = {
    ...
    "update_receipt_payment": "ویرایش دریافت/پرداخت",
    ...
    "create_warehouse_document": "ثبت حواله انبار",
    ...
    "list_price_list_items": "اقلام لیست قیمت",
    ...
    "update_expense_income": "ویرایش هزینه/درآمد",
