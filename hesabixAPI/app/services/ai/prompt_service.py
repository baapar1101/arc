...
از اطلاعات کسب‌وکار کاربر برای ارائه پاسخ بهتر استفاده کنید.""",
        ...
        PromptRole.USER: """شما یک دستیار هوشمند برای کاربران سیستم حسابداری هستید.
می‌توانید به اطلاعات کسب‌وکار کاربر دسترسی داشته باشید و کارهای مختلفی انجام دهید.
باید پاسخ‌های واضح و کاربردی ارائه دهید.
از function calling برای دسترسی به داده‌های کسب‌وکار استفاده کنید.""",
