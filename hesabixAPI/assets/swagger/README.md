...
این دایرکتوری شامل فایل‌های سفارشی‌سازی Swagger UI برای API مارک‌استریت است.
...
2. **Swagger UI سفارشی:** `http://localhost:8000/docs-custom`
   - نسخه سفارشی با استایل‌های مارک‌استریت و پشتیبانی کامل RTL
