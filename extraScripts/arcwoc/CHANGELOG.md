...
### Added
- قطع اتصال امن از حسابیکس با پاکسازی نگاشت‌ها، صف، شناسه‌های وابسته به کسب‌وکار، متای همگام‌سازی و توکن پل
- جریان «تغییر کسب‌وکار» با قطع اتصال خودکار قبل از ویزارد راه‌اندازی مجدد
- گزینهٔ «حذف داده‌ها هنگام Uninstall» در تب سایر
- پاکسازی بهترین‌تلاش تنظیمات پل ووکامرس در کسب‌وکار قبلی حسابیکس هنگام قطع اتصال

### Fixed
- تعویض کسب‌وکار دیگر نگاشت‌ها و شناسه‌های کالای حمل/کارمزد کسب‌وکار قبلی را برای اتصال جدید باقی نمی‌گذارد
- Uninstall اکنون در صورت فعال بودن گزینه، متای همگام‌سازی و cron کشش موجودی را هم پاک می‌کند
