...
نسخه جدید افزونه اتصال ووکامرس به مارک‌استریت با پشتیبانی از API نسخه 2
...
- ✅ ایجاد خودکار فاکتور در مارک‌استریت
...
**مرحله 1: ورود به حساب مارک‌استریت**
- ایمیل و رمز عبور خود را وارد کنید
- سیستم به مارک‌استریت متصل می‌شود
...
### سفارش ووکامرس → فاکتور مارک‌استریت
...
3. در مارک‌استریت V2 ایجاد می‌کند
