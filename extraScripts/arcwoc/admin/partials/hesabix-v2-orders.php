<?php
/**
 * فهرست سفارش‌ها — وضعیت مارک‌استریت، ارسال دسته‌ای، توقف همگام خودکار
 *
 * @package    Hesabix_V2
 */
...
<div class="wrap hesabix-v2-wrap hesabix-v2-orders-page">
	...
	<div class="hesabix-v2-card hesabix-v2-orders-help">
		<p>
			<?php esc_html_e('از اینجا می‌توانید سفارش‌ها را به‌صورت دستی به مارک‌استریت بفرستید یا به‌روز کنید، ارسال را لغو کنید، و در صورت ویرایش دستی فاکتور در مارک‌استریت، همگام‌سازی خودکار ووکامرس را برای همان سفارش متوقف کنید.', 'hesabix-v2'); ?>
		</p>
