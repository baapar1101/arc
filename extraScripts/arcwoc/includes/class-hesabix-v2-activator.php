...
class Hesabix_V2_Activator
{
	...
	public static function activate()
	{
		...
		$default_sync_settings = array(
			...
			'fee_line_mode' => 'service',
			'fee_negative_mode' => 'line_discount',
			'fee_adjustment_account_id' => 0,
			'fee_deduction_account_id' => 0,
			'fee_exclude_from_profit' => true,
			'gateway_settlement_mode' => 'off',
			'gateway_settlement_percent' => 0,
			'gateway_settlement_fixed' => 0,
