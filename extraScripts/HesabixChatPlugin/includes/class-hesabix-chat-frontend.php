		...
		wp_localize_script(
			...
			array(
				...
				'strings'         => array(
					...
					'newChatHint'  => __( 'مکالمه فعلی در فهرست زیر ذخیره می‌شود؛ توکن این چت از مرورگر پاک می‌شود تا بتوانید گفتگوی تازه شروع کنید.', 'hesabix-chat' ),
					'threadPickerLabel' => __( 'گفتگوها', 'hesabix-chat' ),
					'threadCurrentPrefix' => __( 'فعلی', 'hesabix-chat' ),
